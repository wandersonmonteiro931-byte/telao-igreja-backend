import drewLogo from '@assets/Green Blue Bold Modern Creative Studio Logo (2)_1763847382204.png';
import equipeLogo from '@assets/Blue Channel Podcast Multimedia Stream Tv icon logo (3)_1764125660966.png';
        ...
        <div className="text-center space-y-4">
          ...
          <div className="pt-0">
            ...
            <p className="text-xs text-zinc-500">
              Todos os direitos reservados - projetorijreja.shop
            </p>
          </div>
        </div>
      </div>
