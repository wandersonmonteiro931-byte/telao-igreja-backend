    ...
    <div className="min-h-screen bg-background relative">
      ...
      <main className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        >
          ...
          />
          <Card className="p-4 w-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border-blue-500/20">
            <h1 className="text-xl font-bold text-primary text-center" data-testid="text-welcome-team">
