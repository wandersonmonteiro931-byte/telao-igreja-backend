  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const result = await apiRegister({
        ...
        securityQuestion1: pergunta1,
        securityAnswer1: resposta1.toLowerCase().trim(),
        securityQuestion2: pergunta2,
        securityAnswer2: resposta2.toLowerCase().trim(),
        securityQuestion3: pergunta3,
        securityAnswer3: resposta3.toLowerCase().trim(),
      });
